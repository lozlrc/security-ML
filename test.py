...
def main():
    ...
    for ep in range(args.epochs):
        ...
        acc = eval_model(model, Xte, yte, W, inv_perm2, device=device)
        print(f"Epoch {ep}: test acc = {acc:.2f}%")

    print("done.")
    print(f"Π2 perm (perm2) saved implicitly; inv_perm2 used for decoding.")
